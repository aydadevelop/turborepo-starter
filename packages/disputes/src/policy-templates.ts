...
export const FLEXIBLE_CANCELLATION_POLICY: BookingCancellationPolicyProfile = {
	customer: {
		fullRefundHoursBeforeStart: 48,
		partialRefundHoursBeforeStart: 24,
...
export const MODERATE_CANCELLATION_POLICY: BookingCancellationPolicyProfile = {
	customer: {
...
export const STRICT_CANCELLATION_POLICY: BookingCancellationPolicyProfile = {
	customer: {
		fullRefundHoursBeforeStart: 72,
		partialRefundHoursBeforeStart: 24,
...
/** Default profile applied when no per-organization override exists. */
